...
public class ServicioValidador {
    ...
    public static void validarNombre(String nombre) {
        ...
        if (!nombre.matches("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]+$")) {
            throw new FoodStoreException("Error: el nombre contiene caracteres no permitidos.");
        }
    ...
    public static void validarApellido(String apellido) {
        ...
        if (!apellido.matches("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]+$")) {
            throw new FoodStoreException("Error: el apellido contiene caracteres no permitidos.");
        }

        if (apellido.trim().length() < 2) {
            throw new FoodStoreException("Error: el apellido ingresado no es válido.");
        }
    }
    ...
    public static void validarCelular(String celular) {
        ...
        if (celular.startsWith("0")) {
            throw new UsuarioInvalidoException("Error: el número de celular no puede iniciar con 0.");
        }
 ...
 */    
    ...
    public static void validarCantidad(int cantidad) {
        if (cantidad <= 0) {
            throw new StockInvalidoException("Error: la cantidad debe ser mayor que cero.");
        }
    }
